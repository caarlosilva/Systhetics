                                ...
                                <div class="card-body">
                                    <div class="row mb-3">                                      
                                        ...
                                        <div class="col-2 ml-3" >
                                            <a class="nav-link" role="button" data-toggle="modal"  <?php if(isset($prodSelected)) echo 'data-target="#modalAddCarrinho"'?>>
                                                <i class="nc-icon nc-cart-simple"></i><i class="nc-icon nc-stre-right"></i>
                                            </a>
                                        </div>                                           
                                    </div>
                                                        ...
                                                        foreach($carrinho as $produtoCarrinho){
                                                            ...
                                                            <a href="#" class="list-group-item text-center d-flex justify-content-between align-items-center list-group-item-action">                             
                                                                <p>
                                                                    ...
                                                                    <span> R$: <?php echo $prod['preco']; ?></span>
                                                                </p>
                                                                <span class="badge <?php if ($produtoCarrinho['qtdVenda'] <= 0) { echo 'badge-danger';}elseif($produtoCarrinho['qtdVenda'] <= 10){echo 'badge-warning';}else{ echo 'badge-success';}?> badge-pill">Quantidade: <?php echo $produtoCarrinho['qtdVenda'];?></span>
                                                            </a>
                        ...
                        <div class="row">
                            <div class="col-3 mx-2">
                                <div class="input-group ">
                                    ...
                                    <input type="price" class="form-control" value="<?php echo $prodSelected['preco'];?>" name="preco" id="preco" disabled>
                                </div>
                            </div>
                            ...
                            <div class="col mx-2">
                                <div class="input-group ">
                                    ...
                                    <input type="number" name="qtdVenda" id="qtdVenda" min="1" max="<?php echo $prodSelected['quantidade']?>" class="form-control" value="" required>
                                </div>
                            </div>
                        </div>
