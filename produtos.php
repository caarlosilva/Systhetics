                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        <div class="col-2 ml-3" >
                                            <a class="btn btn-success form-control border border-dark" role="button" data-toggle="modal" data-target="#modalCadastroProduto">
                                                ...
                                                <div class="row">
                                                  <div class="col mx-2">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input name="preco" id="preco" type="number" step="any" class="form-control" min="0" placeholder="2019,99" value="<?php echo $prodView['preco'] ;?>">
                                                        </div>
                                                  </div>
                                                  ...
                                                  <div class="col mx-2">
                                                      <div class="input-group mb-3 ">
                                                            ...
                                                            <input name="quantidade" id="quantidade" type="number" min="0" class="form-control" value="<?php echo $prodView['quantidade'] ;?>">
                                                        </div>
                                                  </div>
                                                </div>
                                                <hr>
